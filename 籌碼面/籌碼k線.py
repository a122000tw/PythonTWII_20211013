...
# 取得驗證碼
def get_code(rs):
    res = rs.get('https://bsr.twse.com.tw/bshtm/bsMenu.aspx', verify=False, stream=True, headers=headers, timeout=None)
    # print(res.text)
    # 透過 re 正則表示是來抓取
    ...
    # print('eventvalidation value = : ', eventvalidation.group(0)[26:])
